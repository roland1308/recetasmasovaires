...
*/
SendinblueAPI.prototype.get_report = function (data, cb) {
...
/*
	...
	@options data {Integer} page_limit: This should be a valid number between 1-50 [Mandatory]
*/
SendinblueAPI.prototype.get_folders = function (data, cb) {
...
*/
SendinblueAPI.prototype.get_folder = function (data, cb) {
    var id = data.id;
...
*/
SendinblueAPI.prototype.create_folder = function (data, cb) {
...
*/
SendinblueAPI.prototype.delete_folder = function (data, cb) {
    var id = data.id;
...
*/
SendinblueAPI.prototype.update_folder = function (data, cb) {
    var id = data.id;
...
*/
SendinblueAPI.prototype.delete_bounces = function (data, cb) {
...
/*
	...
	@options data {Array} headers: The headers will be sent along with the mail headers in original email. Example: array("Content-Type"=>"text/html; charset=iso-8859-1"). You can use commas to separate multiple headers [Optional]
*/
SendinblueAPI.prototype.send_transactional_template = function (data, cb) {
    var id = data.id;
...
*/
SendinblueAPI.prototype.create_template = function (data, cb) {
...
/*
	...
	@options data {Integer} attachment: Status of attachment. Possible values = 0 (default) & 1. attach = 0 means an attachment can’t be sent, & attach = 1 means an attachment can be sent, in the email [Optional]
*/
SendinblueAPI.prototype.update_template = function (data, cb) {
    var id = data.id;
...
*/
SendinblueAPI.prototype.get_senders = function (data, cb) {
...
*/
SendinblueAPI.prototype.create_sender = function (data, cb) {
...
/*
	...
	@options data {Array} ip_domain: Pass pipe ( | ) separated Dedicated IP and its associated Domain. Example: "1.2.3.4|mydomain.com". You can use commas to separate multiple ip_domain’s [Mandatory: Only for Dedicated IP clients, for Shared IP clients, it should be kept blank]
*/
SendinblueAPI.prototype.update_sender = function (data, cb) {
    var id = data.id;
...
*/
SendinblueAPI.prototype.delete_sender = function (data, cb) {
    var id = data.id;
